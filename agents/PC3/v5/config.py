...
PARKING_ROWS = 4  # 4 filas
PARKING_COLS = 5  # Reducido de 6 a 5 columnas
TOTAL_SPOTS = PARKING_ROWS * PARKING_COLS  # 20 plazas

# Tipos de plazas
SPOTS_DISCAPACITADOS = 2
SPOTS_ELECTRICOS = 2  # Reducido proporcionalmente
...
INITIAL_VEHICLES = 4  # Reducido proporcionalmente
MAX_VEHICLES = 18     # Reducido proporcionalmente
